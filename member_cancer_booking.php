                ...
                <div class="login-form">
                    <form action="/examples/actions/confirmation.php" method="post">
                        ...
                        <div class="form-group has-error">
                            <h4 class="text-dark">คุณต้องยกเลิกการจองเครื่อง</h4>
                            <b>เครื่องที่ : **</b>
                            <p>จะหมดเวลาอีก : **</p>
                        </div><br>
                        <div class="form-group">
                            <a href="index_member.php"><button type="button" class="btn btn-primary btn-lg btn-block">ยืนยัน</button></a><br>
                            <a href="member_info_booking.php"><button type="button" class="btn btn-danger btn-lg btn-block">ยกเลิก</button></a><br>
