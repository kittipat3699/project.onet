...
$sql = "SELECT * FROM member_table WHERE member_id='{$_SESSION['UserID']}' ";
...
if(isset($_POST['update'])){
  ...
  $update = mysqli_query($connect,"UPDATE member_table set `member_username`='".$username."',`member_password`='".$password."',`member_firstname`='".$name."',`member_lastname`='".$lastname."',`member_gender`='".$gender."',`member_birthday`='".$birthday."',`member_picture`='".$file_name."',`member_email`='".$email."',`member_tel`='".$tel."' WHERE member_id = '".$id."'");

if($update){
  echo "<script>";
  echo "alert(\"บันทึกข้อมูลเรียบร้อยแล้ว\");";
  echo "window.location = 'index_member.php';"; //ไปหน้าเเรก
  echo "</script>";
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <div class="form-group has-error">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Username"
                                required="required" name="username" value="<?php echo $row['member_username']; ?>" readonly>
                        </div>
                        <div class="form-group has-error">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="container text-center">
                            <button type="submit" class="btn btn-primary" name="update" value="update">ยืนยัน</button>
