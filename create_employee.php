...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `employee_table`(`employee_username`,`employee_password`,`employee_firstname`,`employee_lastname`,`employee_gender`,`employee_birthday`,`employee_picture`,`employee_email`,`employee_tel`,`employee_salary`,`status`)
    VALUES('$username','$password','$name','$lastname','$gender','$birthday','$img','$email','$tel','$salary','$status')";
    ...
    if($query){
        ...
        echo "<script>alert('เพิ่มพนักงานไม่สำเร็จ')</script>";
      }
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="กรุณาใส่เงินเดือน"
                                required="required" name="salary">
                        </div> 
                        <div class="form-group">
                            <label for="exampleSelect1">สถานะ</label>
                            <select class="form-control" id="exampleSelect1" name="status"> 
                                <option value="cencer">รออนุมัติ</option>
