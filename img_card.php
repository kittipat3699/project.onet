...
if(isset($_POST['submit'])){
  ...
  $update = mysqli_query($connect,"UPDATE order_card_table set `img_card`='".$file_name."' WHERE order_card = '".$id."'");
...
<body>
    ...
    <div class="container contact-form">
        ...
        <form action="img_card.php" method="post" enctype="multipart/form-data">
            <fieldset>
                <h3>อัพโหลดสลิป</h3>
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <div class="container">
                            ...
                            <a href="member_history_card.php"><button type="button" class="btn btn-danger">Cancel</button></a>
                        </div>
        </form>
    </div>
    </div>
