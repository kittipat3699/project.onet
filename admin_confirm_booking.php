                ...
                <div class="login-form">
                    <form action="/examples/actions/confirmation.php" method="post">
                        ...
                        <div class="form-group has-error">
                            ...
                            <b>เครื่องที่ : **</b>
                            <p>เงื่อนไข : คุณมีเวลาสำหรับการจองเครื่อง 30 นาทีเท่านั้น!!</p>
                        </div><br>
                        <div class="form-group">
                            <a href="admin_countdown.php"><button type="button" class="btn btn-primary btn-lg btn-block">ยืนยัน</button></a><br>
                            <a href="index_member.php"><button type="button" class="btn btn-danger btn-lg btn-block">ยกเลิก</button></a><br>
