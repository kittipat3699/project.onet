...
<head>
    ...
    <title>หน้าเพิ่มยอดขายรายวัน</title>
    <style>
        body{
                    ...
                    <div class="col-md-12">
                      <div class="form-group has-error">
                        ...
                        <div class="form-group has-error">
                            ...
                            <input type="number" class="form-control" id="exampleInputPassword1" max="100000" min="0" placeholder="กรุณาใส่จำนวนเงิน"
                                required="required">
                        </div>
