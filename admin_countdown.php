...
<head>
    ...
    <title>หน้าแสดงผลการจองเครื่อง</title>
    <style>    
    .dropdown-menu {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="employee_admin_card.php">ขายบัตร</a>
        </li>
      </ul>
                ...
                <div class="login-form">
                    <form action="/examples/actions/confirmation.php" method="post">
                        ...
                        <div class="form-group has-error">
                            <h4 class="text-dark">การจองเครื่องเสร็จสิ้น</h4>
                            <!-- เรียกฟังก์ชั่นนับเวลาถอยหลัง -->
                        <div>นับเวลาถอยหลัง <span id="time"></span> นาที</div>
                        <b>ให้กับสมาชิกรหัส####</b>
                        </div><br>
                        <div class="form-group">
                            <a href="index_employee.php"><button type="button" class="btn btn-primary btn-lg btn-block">ตกลง</button></a><br>
                        </div>                        
                    </form>
                </div>
