                ...
                <div class="login-form">
                    <form action="/examples/actions/confirmation.php" method="post">
                        ...
                        <div class="form-group">
                            <a href="index_member.php"><button type="button" class="btn btn-primary btn-lg btn-block">ตกลง</button></a><br>
                            <a href="member_info_booking.php"><button type="button" class="btn btn-success btn-lg btn-block">ดูข้อมูลจองเครื่อง</button></a><br>
                        </div>                        
                    </form>
                </div>
