...
<head>
  ...
  <title>รายงานผลทางการเงินรายเดือน</title>
  <style>
    body{
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'รายได้',
            data: [89000, 35000, 50000, 70000, 60000, 70000, 45000,40000,45000,89000,78000,90000],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
 ...
 <!-- สร้าง table เพื่อใส่ค่ารายรับแบบรายเดือน
<table class="table">
  ...
  <tbody class="bg-light">
    <tr>
      <th class="text-center" scope="row">มกราคม</th>
    ...
    <tr>
      <th class="text-center" scope="row">กุมภาพันธ์</th>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>      
    ...
    <tr>
      <th class="text-center" scope="row">มีนาคม</th>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
    ...
    <tr>
      <th class="text-center" scope="row">เมษายน</th>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
    ...
    <tr>
      <th class="text-center" scope="row">พฤษภาคม</th>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
    ...
    <tr>
      <th class="text-center" scope="row">มิถุนายน</th>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
    ...
    <tr>
      <th class="text-center" scope="row">กรกฎาคม</th>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
      <td class="text-center"></td>
